...
CREATE TABLE IF NOT EXISTS withdrawals (
  ...
  -- Withdrawal method
  withdrawal_type VARCHAR(50) NOT NULL CHECK (withdrawal_type IN ('card', 'iban')), -- 'card' or 'iban'
  ...
  card_number VARCHAR(255), -- encrypted in production
  card_holder VARCHAR(255),
  
  -- Transaction details
  amount DECIMAL(18, 8) NOT NULL CHECK (amount > 0),
  platform_fee DECIMAL(18, 8) NOT NULL DEFAULT 0, -- calculated as amount * 0.20
  total_amount DECIMAL(18, 8) NOT NULL, -- amount + platform_fee
