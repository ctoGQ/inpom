...
export default async function Home() {
  ...
  return <main className="relative min-h-screen overflow-x-hidden ">
    ...
    {/* <ManifestoSection quote="Коли одна жінка отримує можливість, змінюється більше, ніж її особиста історія." detail="INPOM створений, щоб перетворювати взаємну підтримку на довготривалі можливості для жінок та їхніх спільнот." href="/community" /> */}
    {/* <LinkedRouteCards title="Оберіть свій наступний крок" description="Почніть із того, що зараз найближче. Далі система сама відкриє наступні двері." links={[{ title: "Знайти спільноту", description: "Підтримка, знайомства та місце для вашого голосу.", href: "/community" }, { title: "Розвивати ідею", description: "Менторинг, проєкти та партнери для руху вперед.", href: "/development" }, { title: "Вийти у світ", description: "Міжнародні зв&apos;язки, програми та нові горизонти.", href: "/international" }]} /> */}
