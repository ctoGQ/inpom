...
export default function ProjectsPage() {
  return (
    <PublicPageLayout>
      <PublicHero eyebrow="Проєкти" title="Ідеї, які стають спільною дією" description="Створюйте соціальні, благодійні та міжнародні ініціативи, знаходьте команду, партнерів і ресурси для реалізації." action={{ label: "Створити проєкт", href: "/signup" }} />
