...
import { FeatureGrid, ImageSplitSection, JourneySection, LinkedRouteCards, PublicHero, TimelineSection, TransparencySection } from "@/components/contentsections/public-sections"
...
export default function AboutPage() {
  return (
    <PublicPageLayout>
      ...
      <ImageSplitSection eyebrow="Наша оптика" title="Ми дивимося на можливості як на мережу зв’язків" description="Підтримка не закінчується однією відповіддю. Вона може привести до менторки, команди, проєкту, партнерства або міжнародного контакту — і кожен наступний крок залишається у ваших руках." image="/images/inpom-partnership.png" alt="Жінки готують спільний проєкт за столом" href="/projects" linkLabel="Побачити, як працює екосистема" reverse />
      <TimelineSection />
      <TransparencySection />
      <LinkedRouteCards title="З історії — у дію" links={[{ title: "Бути поруч", description: "Приєднатися до спільноти та знайти своє коло.", href: "/community" }, { title: "Читати голоси", description: "Слідкувати за новинами та історіями учасниць.", href: "/newsletter" }, { title: "Відкрити двері", description: "Обговорити партнерство або запропонувати ідею.", href: "/partnership" }]} />
    </PublicPageLayout>
  )
}
