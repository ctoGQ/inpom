...
export default function CommunityPage() {
  return (
    <PublicPageLayout>
      <PublicHero eyebrow="Спільнота" title="Місце, де підтримка стає можливістю" description="INPOM об'єднує жінок, експерток, підприємниць і лідерок, щоб кожна могла знайти допомогу, проявити компетенції та створити можливості для інших." action={{ label: "Приєднатися", href: "/signup" }} />
