...
const steps = [
  {
    number: "01",
    title: "Реєстрація",
    subtitle: "в спільноті",
    description: "Приєднайтесь до парламенту матерів. Заповніть профіль, виберіть ваші інтереси і отримайте доступ до ресурсів.",
    code: `const mother = new Member({
  interests: ['consulting', 'business'],
  country: 'Ukraine',
  mentor: true,
  community: true
})`,
  },
  {
    ...
    title: "Вибір",
    subtitle: "пакету",
    description: "Оберіть один з 3 пакетів супроводження з менторингом, обученням та доступом до експертів вашої сфери.",
    code: `await mother.selectPlan({
  plan: 'Professional',
  mentors: ['legal', 'business'],
  support: '24/7',
  duration: '6m'
})`,
  },
  {
    ...
    title: "Розвиток",
    subtitle: "& успіх",
    description: "Розвивайте ваш бізнес або проект з підтримкою партнерів. Маємо 500+ компаній та благодійних організацій.",
    code: `mothers.dashboard({
  mentors: [experts],
  partners: [500+],
  growth: '1000x',
  results: 'real'
})
// 9000+ успішних матерів`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Реєстрація.</span>
              <span className="block text-white/30">Вибір.</span>
              <span className="block text-white/10">Успіх.</span>
            </h2>
          </div>
