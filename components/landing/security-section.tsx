...
const securityFeatures = [
  {
    icon: Shield,
    title: "Приватність матерів",
    description: "Дані матерів в безпеці. Цифрова конфіденційність гарантована.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Шифрування всього",
    description: "Персональна інформація захищена шифруванням.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Прозрачні звіти",
    description: "Кожна дія записується і доступна для перевірки.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Контроль прав",
    description: "Матері мають повний контроль своїх даних.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["ISO 27001", "GDPR", "Захист даних", "NCSA"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Захист,
            <br />
            <span className="text-muted-foreground">а не контроль.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Матері мають свободу, але дані захищені. Найвища безпека з бізнес-гнучкістю.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Захист даних</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">0</span>
                <span className="block text-muted-foreground mt-2">Витоків даних за рік</span>
              </div>
            </div>
