...
const navLinks = [
  ...
  { name: "Процес",        href: "#how-it-works"  },
  { name: "Мережа",        href: "#infra"          },
  { name: "Партнери",      href: "#integrations"  },
  { name: "Захист",        href: "#security"      },
];
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>MOTHERS</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="/auth/signin" className={`transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              Вхід
            </a>
            <Button
              size="sm"
